        ...
        <CommandList>
          ...
          <CommandGroup heading={t("actions")}>
            <CommandItem onSelect={() => {
              ...
              <Icon icon="solar:book-add-bold-duotone" className="mr-2 h-4 w-4" />
              {t("newCourse")}
              <CommandShortcut>⌘N</CommandShortcut>
            </CommandItem>
            <CommandItem>
              <Icon icon="solar:chat-square-call-bold-duotone" className="mr-2 h-4 w-4" />
              {t("newDiscussion")}
      ...
      <header className="sticky top-4 mx-4 z-50">
        <div className="rounded-2xl border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between gap-x-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-[380px] rounded-2xl p-0 shadow-lg border bg-gradient-to-b from-background/95 to-background/98 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <div className="relative">
                        <Avatar className="h-8 w-8 ring-2 ring-background transition-all duration-300 group-hover:scale-110 group-data-[state=open]:ring-primary group-hover:ring-primary/50 group-hover:shadow-lg group-hover:shadow-primary/20">
                          <AvatarImage
                        ...
                        <div className="absolute -bottom-1 -right-1 h-3 w-3">
                          <span className="animate-pulse block h-3 w-3 rounded-full bg-emerald-500 ring-2 ring-background" />
                        </div>
                        <span className="absolute inset-0 rounded-full bg-primary/10 animate-ping-slow opacity-75" />
                      </div>
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent 
